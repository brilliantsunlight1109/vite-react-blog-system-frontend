...
const UpdateStylist = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`api/stylist/${id}`);
        setData({
          name: response.data.name,
          furigana: response.data.furigana,
          stylist_assistant: response.data.stylist_assistant,
  ...
  const handleDelete = () => {
    axios
      ...
      .catch((err) => {
        console.log("Error couldn't delete Stylist");
        console.log(err.message);
      });
  };
  return (
